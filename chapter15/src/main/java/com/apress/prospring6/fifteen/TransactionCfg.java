...
@Configuration
@EnableJpaRepositories(basePackages = {"com.apress.prospring6.fifteen.repos"})
@EnableTransactionManagement
@ComponentScan(basePackages = {"com.apress.prospring6.fifteen.repos"})
public class TransactionCfg {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
        ...
        factory.setPackagesToScan("com.apress.prospring6.fifteen.entities");
