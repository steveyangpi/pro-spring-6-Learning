...
import com.apress.prospring6.seventeen.boot.problem.NotFoundException;
import com.apress.prospring6.seventeen.boot.repos.SingerRepo;
import com.apress.prospring6.seventeen.boot.util.CriteriaDto;
import com.apress.prospring6.seventeen.boot.util.FieldGroup;
...
public class SingerServiceImpl implements SingerService {
    ...
    @Override
    public List<Singer> findAll() {return singerRepo.findAll(Sort.unsorted());}

    @Override
    public void delete(Long id) {singerRepo.deleteById(id);}
    ...
    @Override
    public Singer save(Singer singer) {return singerRepo.save(singer);}

    @Override
    public Page<Singer> findAllByPage(Pageable pageable) {return singerRepo.findAll(pageable);}
