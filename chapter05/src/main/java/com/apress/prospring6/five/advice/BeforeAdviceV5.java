...
@Component
@Aspect
public class BeforeAdviceV5 {
    private static Logger LOGGER = LoggerFactory.getLogger(BeforeAdviceV5.class);

    public BeforeAdviceV5() {
        LOGGER.info("BeforeAdviceV5 creation time: {}" , Instant.now());
    }
